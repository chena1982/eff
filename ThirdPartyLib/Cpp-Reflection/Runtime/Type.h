    ...
    namespace meta
    {
        ...
        public:
            ...
            */
            ...
            template<typename ClassType>
            static YAML::Emitter SerializeYaml(const ClassType &instance, bool invokeHook = true);

            void SerializeYaml(YAML::Emitter & output, const Variant &instance, bool invokeHook = true) const;
            void SerializeYaml(YAML::Emitter & output, const Variant &instance, SerializationGetterOverride getterOverride, bool invokeHook = true) const;

            template<typename ClassType>
            static ClassType DeserializeYaml(const YAML::Emitter &value);

            Variant DeserializeYaml(const YAML::Node &value) const;
            Variant DeserializeYaml(const YAML::Node &value, const Constructor &ctor) const;
            void DeserializeYaml(Variant &instance, const YAML::Node &value) const;
