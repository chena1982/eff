...
function(meta_parser_prebuild)
    ...
    message(STATUS "prebuild meta source root ${PREBUILD_META_SOURCE_ROOT}")
    message(STATUS "prebuild meta module header ${PREBUILD_META_MODULE_HEADER}")
    ...
    foreach (HEADER ${PREBUILD_META_HEADER_FILES})
        ...
        message(STATUS "prebuild meta header files ${HEADER}")
        ...
        message(STATUS "prebuild meta header files directory ${DIRECTORY_NAME}")        
        ...
        if (NOT "${EXTENSION}" STREQUAL ".hpp")
            ...
            message(STATUS "prebuild meta header files relative ${RELATIVE}")            
            ...
            message(STATUS "generated source ${GENERATED_SOURCE}")              
...
function(meta_parser_build)
    ...
    message(STATUS "pch file name ${BUILD_META_PCH_NAME}")
    ...
    foreach (GENERATED_FILE ${BUILD_META_GENERATED_FILES})
        ...
        if (NOT EXISTS ${GENERATED_FILE})
            if ("${EXTENSION}" STREQUAL ".Generated.h")
                ...
                message(STATUS "write file ${GENERATED_FILE} ${EMPTY_SOURCE_CONTENTS}")
            endif ()
        endif ()
    endforeach ()
    ...
    message(STATUS "add command output ${BUILD_META_GENERATED_FILES}")
    message(STATUS "add command depends ${BUILD_META_HEADER_FILES}")
    message(STATUS "add command command ${BUILD_META_PARSER_EXECUTABLE}")
    message(STATUS "add command target ${BUILD_META_TARGET}")
    message(STATUS "add command source-root ${BUILD_META_SOURCE_ROOT}")
    message(STATUS "add command in-source ${BUILD_META_SOURCE_ROOT}/${BUILD_META_SOURCE_FILE}")
    message(STATUS "add command module-header ${BUILD_META_SOURCE_ROOT}/${BUILD_META_MODULE_HEADER}")
    message(STATUS "add command out-source ${BUILD_META_MODULE_SOURCE_FILE}")
    message(STATUS "add command out-dir ${BUILD_META_GENERATED_DIR}")                        
    message(STATUS "add command pch_switch ${PCH_SWITCH}")
    message(STATUS "add command includes ${INCLUDES_FILE}")    
    message(STATUS "add command defines_switch ${DEFINES_SWITCH}")
