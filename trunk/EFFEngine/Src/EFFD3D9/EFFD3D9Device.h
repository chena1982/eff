...
public:
	...
	virtual effHRESULT			CreateRenderTarget(effUINT Width,effUINT Height,EFF3DFORMAT Format,EFF3DMULTISAMPLE_TYPE MultiSample,
															effUINT MultisampleQuality,effBOOL Lockable,EFF3DSurface** ppSurface);
	virtual effHRESULT			CreateDepthStencilSurface(effUINT Width,effUINT Height,EFF3DFORMAT Format,EFF3DMULTISAMPLE_TYPE MultiSample,
															effUINT MultisampleQuality,effBOOL Discard,EFF3DSurface** ppSurface);
...
protected:
	virtual EFF3DIResource *	CreateEmptyResource(EFF3DRESOURCETYPE resourceType);
protected:
	LPDIRECT3D9					m_pD3D;       
