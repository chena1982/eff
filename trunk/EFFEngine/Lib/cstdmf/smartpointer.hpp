...
public:
	 ...
	 *	Copy constructor.
	 */
	ReferenceCount( const ReferenceCount & /*rOther*/ ) : count_(0) {}
...
//			throw bad_reference_count(count_-1);
		if (--count_ == 0) delete const_cast<ReferenceCount*>(this);
	}
...
//template <class Ty>
//inline void destroyReferenceCount( const Ty &Q )
//{
//	int i = Q.refCount();
//	Q.decRef();
//}
...
public:
	...
	{
		object_ = P;
		if (object_ && !alreadyIncremented) incrementReferenceCount( *object_ );
	}
...
public:
	...
	SmartPointer( ConstSmartPointer<DerivedType>& dt ) : ConstProxy( dt.getObject() ) { }
	...
	{
		ConstProxy::operator=(dt.getObject());
		return *this;
	}
