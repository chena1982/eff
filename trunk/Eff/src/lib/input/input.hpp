...
public:
	...
	static InputDevices & instance()			{ return instance_; }

	static bool init( void * hInst, void * hWnd, int flags );
	...
	static Joystick & joystick()	{ return instance_.joystick_; }
	...
	static bool * keyDownTable()	{ return instance_.isKeyDown_; }
