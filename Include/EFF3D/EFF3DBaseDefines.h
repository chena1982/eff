...
typedef EFFId EFF3DShaderResourceViewHandle;
typedef EFFId EFF3DUnorderedAccessViewHandle;
...
enum EFF3DFormat
{
    EFF3D_FORMAT_BC1,          //!< DXT1
    EFF3D_FORMAT_BC2,          //!< DXT3
    EFF3D_FORMAT_BC3,          //!< DXT5
    EFF3D_FORMAT_BC4,          //!< LATC1/ATI1
    EFF3D_FORMAT_BC5,          //!< LATC2/ATI2
    EFF3D_FORMAT_BC6H,         //!< BC6H
    EFF3D_FORMAT_BC7,          //!< BC7
    EFF3D_FORMAT_ETC1,         //!< ETC1 RGB8
    EFF3D_FORMAT_ETC2,         //!< ETC2 RGB8
    EFF3D_FORMAT_ETC2A,        //!< ETC2 RGBA8
    EFF3D_FORMAT_ETC2A1,       //!< ETC2 RGB8A1
    EFF3D_FORMAT_PTC12,        //!< PVRTC1 RGB 2BPP
    EFF3D_FORMAT_PTC14,        //!< PVRTC1 RGB 4BPP
    EFF3D_FORMAT_PTC12A,       //!< PVRTC1 RGBA 2BPP
    EFF3D_FORMAT_PTC14A,       //!< PVRTC1 RGBA 4BPP
    EFF3D_FORMAT_PTC22,        //!< PVRTC2 RGBA 2BPP
    EFF3D_FORMAT_PTC24,        //!< PVRTC2 RGBA 4BPP

    EFF3D_FORMAT_UNKNOWN,      // Compressed formats above.
    ...
    EFF3D_FORMAT_RGBA8S,
    EFF3D_FORMAT_RGBA16,
    EFF3D_FORMAT_RGBA16I,
    EFF3D_FORMAT_RGBA16U,
    EFF3D_FORMAT_RGBA16F,
    EFF3D_FORMAT_RGBA16S,
    EFF3D_FORMAT_RGBA32I,
    EFF3D_FORMAT_RGBA32U,
    EFF3D_FORMAT_RGBA32F,
    EFF3D_FORMAT_R5G6B5,
    EFF3D_FORMAT_RGBA4,
    EFF3D_FORMAT_RGB5A1,
    EFF3D_FORMAT_RGB10A2,
    EFF3D_FORMAT_RG11B10F,

    EFF3D_FORMAT_UNKNOWN_DEPTH, // Depth formats below.
