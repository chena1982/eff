...
template <> BackwardCompatibilityManager* MyGUI::Singleton<BackwardCompatibilityManager>::msInstance = nullptr;
template <> const char* MyGUI::Singleton<BackwardCompatibilityManager>::mClassTypeName = "BackwardCompatibilityManager";
