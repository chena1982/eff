...
template <> WidgetSelectorManager* MyGUI::Singleton<WidgetSelectorManager>::msInstance = nullptr;
template <> const char* MyGUI::Singleton<WidgetSelectorManager>::mClassTypeName = "WidgetSelectorManager";
