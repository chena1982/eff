...
template <> EditorWidgets* MyGUI::Singleton<EditorWidgets>::msInstance = nullptr;
...
void EditorWidgets::parseWidget(MyGUI::xml::ElementEnumerator& _widget, MyGUI::Widget* _parent, bool _testMode)
{
	...
	if (_widget->findAttribute("position_real", position))
	{
		...
		MyGUI::IntSize textureSize = tools::SettingsManager::getInstance().getValue<MyGUI::IntSize>("Settings/WorkspaceTextureSize");
